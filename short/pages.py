...
class Period1(Page):
    ...
    def vars_for_template(self):
        ...
        if self.participant.vars['treatment'] == 'short_first':
...
class Period16(Page):
    ...
    def before_next_page(self):
        if self.participant.vars['total_saving16'] <= self.player.expense16:
...
page_sequence = [Start, Start_to_S, Period1, Period2, Period3, Period4, Period5, Period6, Period7, Period8, Period9,
                 Period10, Period11, Period12, Period13, Period14, Period15, Period16, End_short]
