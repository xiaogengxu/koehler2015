    ...
    def creating_session(self):
        ...
        for player in self.get_players():
            ...
            player.participant.vars['spend_text'] = _('You have less Savings than you need '
                                                      ...
                                                      'You are in debt and will not make any Spending decision.')
            ...
            for r in range(1, 3):
                ...
                for j in range(1, 17):
                    ...
                    setattr(player.in_round(r), str_income, income_seq[j-1])
                    setattr(player.in_round(r), str_expense, expense_seq[j-1])
